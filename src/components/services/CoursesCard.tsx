...
const CoursesCard: React.FC<CoursesCardProps> = ({
  ...
  return (
    <div className="bg-white p-8 rounded-lg shadow-lg max-w-4xl mx-auto">
      ...
      />
      <p className="text-lg text-gray-800 mb-6">{header}</p>

      <h3 className="text-xl font-bold text-gray-800 mb-2">Content</h3>
      ...
      <button className="px-6 py-3 bg-green-800 text-white text-lg rounded-lg hover:bg-green-700 transition">
        Read More
      </button>
    </div>
  );
